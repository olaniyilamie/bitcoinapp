...
@section('content')
    ...
    <div class="row">
        <div class="col-12 p-0">
            <h2 class="miniheading rounded">GOOGLEPLAY <i class="fab fa-google-play"></i></h2>
        </div>
    </div>
                ...
                <div class="col-12">
                    <ul class="px-0 py-0">
                        <li class="giftcardType">
                            <label for="0"> 
                                <input name="gt_googleplay" type="radio" value="0" checked="checked" id="0">
                                USA Google (50-100) ₦400
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="1">
                                <input name="gt_googleplay" type="radio" value="1" id="1">
                                USA Google ($150-200) ₦400
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="2">
                                <input name="gt_googleplay" type="radio" value="2" id="2">
                                USA ($10-$100 Ecode) ₦345
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="3">
                                <input name="gt_googleplay" type="radio" value="3" id="3">
                                UK Google ₦435
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="4">
                                <input name="gt_googleplay" type="radio" value="4" id="4">
                                CAD Google ₦ 270
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="5">
                                <input name="gt_googleplay" type="radio" value="5" id="5">
                                AUD Google ₦230
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="6">
                                <input name="gt_googleplay" type="radio" value="6" id="6">
                                Euro Google ₦375
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="7">
                                <input name="gt_googleplay" type="radio" value="7" id="7">
                                CHF Google ₦415
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="8">
                                <input name="gt_googleplay" type="radio" value="8" id="8">
                                KRW Google ₦194
                            </label>
                        </li>
                    </ul>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("input[type=radio][name=gt_googleplay]").on("change", itunesPrice );
        $("#quantity").on("keyup", itunesPrice );

        function itunesPrice(){
            let checked=$("input[name='gt_googleplay']:checked").val();
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name=csrf-token]').attr('content')
                    },
                url:"{{route('get_googleplay_price')}}",
                type:'POST',
                data:{'key': checked },
                dataType:'text',
