...
@section('content')
    ...
    <div class="row">
        <div class="col-12 p-0">
            <h2 class="miniheading rounded">STEAM <i class="fab fa-steam-square"></i></h2>
        </div>
    </div>
                ...
                <div class="col-12">
                    <ul class="px-0 py-0">
                        <li class="giftcardType">
                            <label for="0"> 
                                <input name="gt_steam" type="radio" value="0" checked="checked" id="0">
                                USA Steam($20 single) ₦395
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="1">
                                <input name="gt_steam" type="radio" value="1" id="1">
                                USA Steam($50 - $500 single) ₦395
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="2">
                                <input name="gt_steam" type="radio" value="2" id="2">
                                UK Steam ₦525
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="3">
                                <input name="gt_steam" type="radio" value="3" id="3">
                                CAD Steam ₦295
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="4">
                                <input name="gt_steam" type="radio" value="4" id="4">
                                AUD Steam ₦265
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="5">
                                <input name="gt_steam" type="radio" value="5" id="5">
                                NZD Steam ₦255
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="6">
                                <input name="gt_steam" type="radio" value="6" id="6">
                                Euro Steam ₦435
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="7">
                                <input name="gt_steam" type="radio" value="7" id="7">
                                Euro Steam Ecode ₦415
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="8">
                                <input name="gt_steam" type="radio" value="8" id="8">
                                USA Steam Ecode ₦355
                            </label>
                        </li>
                        <li class="giftcardType">
                            <label for="9">
                                <input name="gt_steam" type="radio" value="9" id="9">
                                CHF Steam ₦415
                            </label>
                        </li>
                    </ul>
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-12 form-group{{ $errors->has('itunesQty') ? ' has-error' : '' }}">
                    <input type="number" name="itunesQty" id="quantity" placeholder="560" min="20" max="2000" class="form-control form-control-sm" value="{{ old('itunesQty')}}" required>
                    <small class="text-muted" id="qtyMsg">Please enter a number from 20 to 2000.</small>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("input[type=radio][name=gt_steam]").on("change", itunesPrice );
        $("#quantity").on("keyup", itunesPrice );

        function itunesPrice(){
            let checked=$("input[name='gt_steam']:checked").val();
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name=csrf-token]').attr('content')
                    },
                url:"{{route('get_steam_price')}}",
                type:'POST',
                data:{'key': checked },
                dataType:'text',
                success:function(itunesRate){
                    if($('#quantity').val() !=='' && $('#quantity').val() < 20 ){
                        $('#qtyMsg').html('quantity cannot be less than 20');
